...
function Sprite(scene, imageFile, width, height){ 
  ...
  this.collidesWith = function(sprite){
	...
	myLeft = this.x - 25;
	myRight = this.x + 25;
	myTop = this.y - (this.height / 25);
	myBottom = this.y + (this.height / 25);
	otherLeft = sprite.x - 25;
	otherRight = sprite.x + 25;
	otherTop = sprite.y - (sprite.height / 25);
	otherBottom = sprite.y + (sprite.height / 25);
